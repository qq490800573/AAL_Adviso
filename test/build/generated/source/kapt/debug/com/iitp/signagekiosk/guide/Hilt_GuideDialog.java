...
public abstract class Hilt_GuideDialog extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GuideDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GuideDialog_GeneratedInjector) this.generatedComponent()).injectGuideDialog(UnsafeCasts.<GuideDialog>unsafeCast(this));
    }
  }
