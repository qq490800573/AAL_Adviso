...
public abstract class Hilt_LoadingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LoadingFragment() {
    super();
  }

  Hilt_LoadingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LoadingFragment_GeneratedInjector) this.generatedComponent()).injectLoadingFragment(UnsafeCasts.<LoadingFragment>unsafeCast(this));
    }
  }
