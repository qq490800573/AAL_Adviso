...
public class LayoutAnswerRightOrWrongBindingImpl extends LayoutAnswerRightOrWrongBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.textView35, 3);
        sViewsWithIds.put(R.id.textView37, 4);
    }
    // views
    @NonNull
    ...
    public LayoutAnswerRightOrWrongBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private LayoutAnswerRightOrWrongBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
