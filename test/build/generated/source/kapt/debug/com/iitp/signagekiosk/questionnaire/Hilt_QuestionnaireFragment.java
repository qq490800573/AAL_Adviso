...
public abstract class Hilt_QuestionnaireFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QuestionnaireFragment() {
    super();
  }

  Hilt_QuestionnaireFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QuestionnaireFragment_GeneratedInjector) this.generatedComponent()).injectQuestionnaireFragment(UnsafeCasts.<QuestionnaireFragment>unsafeCast(this));
    }
  }
