...
public abstract class Hilt_EmergencyDialog extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EmergencyDialog() {
    super();
  }

  Hilt_EmergencyDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EmergencyDialog_GeneratedInjector) this.generatedComponent()).injectEmergencyDialog(UnsafeCasts.<EmergencyDialog>unsafeCast(this));
    }
  }
