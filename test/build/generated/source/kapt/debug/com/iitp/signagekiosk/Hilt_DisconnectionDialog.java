...
public abstract class Hilt_DisconnectionDialog extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DisconnectionDialog() {
    super();
  }

  Hilt_DisconnectionDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DisconnectionDialog_GeneratedInjector) this.generatedComponent()).injectDisconnectionDialog(UnsafeCasts.<DisconnectionDialog>unsafeCast(this));
    }
  }
