...
private const val address = "E4:5F:01:26:63:E8"
    ...
    val positionState = channelFlow {
        ...
        distance.combine(detection.onStart { emit(Detection.ACTIVE) }) { distance, detection ->
            when {
                ...
                distance in Distance.D70..Distance.D90 -> PositionState.FIT
                distance in Distance.D100..Distance.D120 -> PositionState.FAR
